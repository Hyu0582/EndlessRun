...
public class RedSwordSpawner : MonoBehaviour
{
    ...
    void SpawnObstacle()
    {
        spawnRate = Random.Range(0, 11) == 0 ? spawnRates[0] : spawnRates[Random.Range(1, spawnRates.Length)];
        ...
        obstacle.transform.localScale = new Vector3(obsLocalScale.x, Random.Range(0, 4) == 0 ? -1 : 1, obsLocalScale.z);
